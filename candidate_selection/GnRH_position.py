...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 15:04:28 2025
...
for cluster in [1, 2, 4, 5]:
    cluster_files[cluster] = [
        ...
        if file.endswith('.pdb') and f'c.{cluster}.' in file
    ]

pocket_residues_info = [
    (23, 'pink', 'L23'), (38, 'gold', 'R38'), (174, 'chocolate', 'Q174'),
    (178, 'violet', 'F178'), (280, 'gray', 'W280'), (283, 'limegreen', 'Y283'),
    (284, 'limegreen', 'Y284'), (286, 'pink', 'L286'), (290, 'limegreen', 'Y290'),
    (306, 'mediumturquoise', 'H306'), (323, 'limegreen', 'Y323'), (302, 'red', 'D302'),
    (102, 'goldenrod', 'N102'), (121, 'skyblue', 'K121'), (98, 'red', 'D98')
]
